...
/**
 * Loads the Phase 4 "simple" cash versus GL reconciliation example.
 */
@Component
@Order(10)
public class SimpleCashGlEtlPipeline extends AbstractSampleEtlPipeline {

    private static final String DEFINITION_CODE = "CASH_VS_GL_SIMPLE";

    public SimpleCashGlEtlPipeline(
    ...
    public void run() {
        ...
        List<SourceRecordB> sourceBRecords = readCsv("etl/simple/cash_gl_source_b.csv").stream()
